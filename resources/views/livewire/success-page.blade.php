        ...
        <div
            ...
            <div>
                        ...
                        <div class="flex flex-col w-full space-y-6 ">
                            ...
                            <div
                                ...
                                <div class="flex justify-between w-full">
                                    ...
                                    <p class="text-base leading-4 text-gray-600 dark:text-gray-400">Rp157,495.00</p>
                                </div>
                ...
                <div class="flex items-center justify-start gap-4 px-4 mt-6 ">
                    ...
                    <a href="/orders"
                        class="w-full text-center px-4 py-2 bg-orange-500 rounded-md text-gray-50 md:w-auto dark:text-gray-300 hover:bg-blue-600 dark:hover:bg-gray-700 dark:bg-gray-800">
                        View My Orders
                    </a>
                </div>
            </div>
