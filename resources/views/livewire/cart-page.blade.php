        ...
        <div class="flex flex-col md:flex-row gap-4">
                        ...
                        <tbody>
                            ...
                            @forelse ($cart_items as $item)
                                <tr wire:key='{{ $item['product_id'] }}'>
                                    ...
                                    <td>
                                        <button wire:click='removeItems({{ $item['product_id'] }})'
                                            class="bg-slate-300 border-2 border-slate-400 rounded-lg px-3 py-1 hover:bg-red-500 hover:text-white hover:border-red-700"><span
                                                ...
                                                wire:loading>Removing...</span></button>
                                    </td>
                                </tr>
                            @empty
                                <tr>
            ...
            <div class="md:w-1/4">
                <div class="bg-white rounded-lg shadow-md p-6">
                    ...
                    @if ($cart_items)
                        <a href="/checkout" class="bg-orange-500 block text-center text-white py-2 px-4 rounded-lg mt-4 w-full">Checkout</a>
                    @endif
                </div>
            </div>
        </div>
