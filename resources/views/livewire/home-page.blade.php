<div>
    <!-- Hero Section start -->
    <div class="w-full h-screen bg-gradient-to-r from-orange-200 to-red-200 py-10 px-4 sm:px-6 lg:px-8 mx-auto">
            ...
            <div class=" grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
                <div>
                    <h1
                        ...
                        Find everything you needFind everything you need <span class="text-red-600">Infinity
                            Shop.</span></h1>
                    <p class="mt-3 text-lg text-gray-800 dark:text-gray-400">Buy a wide range of electronic products such
                        as Smartphones, Laptops, Smartwatches, Televisions, and many more.</p>

                    <!-- Buttons -->
                    <div class="mt-7 grid gap-3 w-full sm:inline-flex">
                        <a class="py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-orange-600 text-white hover:bg-orange -700 disabled:opacity-50 disabled:pointer-events-none dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                            href="/register">
                            Get started
                ...
                <div class="relative ms-4">
                    <img class="w-full rounded-md" src="images/logo1.png" class="h-10" alt="Image Description">
                </div>
                <!-- End Col -->
            </div>
            <!-- End Grid -->
    ...
    <!-- Brand Section start -->
    <div class="w-full h-screen bg-gradient-to-r from-orange-300 to-red-300 py-10 px-4 sm:px-6 lg:px-8 mx-auto">
        <section class="py-20">
            <div class="max-w-xl mx-auto">
                <div class="text-center ">
                    <div class="relative flex flex-col items-center">
                        <h1 class="text-5xl font-bold dark:text-gray-200"> Popular <span class="text-orange-500">
                                Brands
                            </span> </h1>
                    ...
                    <p class="mb-12 text-base text-center text-gray-500">
                        Our electronics brands deliver advanced technology with the highest quality to make your life
                        easier. With elegant designs and the latest innovations, our products provide comfort and
    ...
    <div class="bg-gradient-to-r from-orange-200 to-red-200 py-20">
        <div class="max-w-xl mx-auto">
            <div class="text-center ">
                <div class="relative flex flex-col items-center">
                    <h1 class="text-5xl font-bold dark:text-gray-200"> Browse <span class="text-orange-500">
                            Categories
                        </span> </h1>
                    <div class="flex w-40 mt-2 mb-6 overflow-hidden rounded">
                        <div class="flex-1 h-2 bg-orange-200">
        ...
        <div class="max-w-[85rem] px-4 sm:px-6 lg:px-8 mx-auto">
            <div class="grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3 sm:gap-6">
                ...
                @foreach ($categories as $category)
                    <a class="group flex items-center bg-white border shadow-sm rounded-xl hover:shadow-md transition dark:bg-slate-900 dark:border-gray-800 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                        ...
                        <div class="p-4 md:p-5 flex flex-1 items-center">
                            ...
                            <div class="ms-3">
                                <h3
                                    class="group-hover:text-red-600 font-semibold text-gray-800 dark:group-hover:text-gray-400 dark:text-gray-200">
                                    {{ $category->name }}
                                </h3>
                            </div>
                        </div>
                        <div class="p-4">
                            <svg class="flex-shrink-0 w-5 h-5 text-gray-500 group-hover:text-red-600 dark:group-hover:text-gray-400 dark:text-gray-200"
    ...
    <section class="py-14 font-poppins bg-gradient-to-r from-orange-300 to-red-300">
        <div class="max-w-6xl px-4 py-6 mx-auto lg:py-4 md:px-6">
            <div class="max-w-xl mx-auto">
                <div class="text-center ">
                    <div class="relative flex flex-col items-center">
                        <h1 class="text-5xl font-bold dark:text-gray-200"> Customer <span class="text-orange-500">
                                Reviews
                            </span> </h1>
                        <div class="flex w-40 mt-2 mb-6 overflow-hidden rounded">
                            <div class="flex-1 h-2 bg-orange-200">
                                ...
                                <li>
                                    <a href="#">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                            fill="currentColor"
                                            class="w-4 mr-1 text-red-500 dark:text-red-400 bi bi-star-fill"
                                            viewBox="0 0 16 16">
                                            <path
                            ...
                            <div class="flex items-center">
                                <div class="flex mr-3 text-sm text-gray-700 dark:text-gray-400">
                                    <a href="#">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                            fill="currentColor"
                                            class="w-4 h-4 mr-1 text-red-400 bi bi-hand-thumbs-up-fill"
                                            viewBox="0 0 16 16">
                                            <path
                                ...
                                <div class="flex text-sm text-gray-700 dark:text-gray-400">
                                    <a href="#" class="inline-flex hover:underline">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                            fill="currentColor" class="w-4 h-4 mr-1 text-red-400 bi bi-chat"
                                            viewBox="0 0 16 16">
                                            <path
