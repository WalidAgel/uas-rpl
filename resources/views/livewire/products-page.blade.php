<div class="w-full bg-gradient-to-r from-orange-200 to-red-200 py-10 px-4 sm:px-6 lg:px-8 mx-auto">
    <section class="py-10 bg-gray-50 font-poppins dark:bg-gray rounded-lg">
                    ...
                    <div class="p-4 mb-5 bg-white border border-gray-200 dark:bg-gray-900 dark:border-gray-900">
                        ...
                        <div>
                            ...
                            <div class="flex justify-between ">
                                <span class="inline-block text-lg font-bold text-blue-400 ">Rp 1.000.000</span>
                                <span class="inline-block text-lg font-bold text-blue-400 ">Rp 50.000.000</span>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="w-full px-3 mb-6 sm:w-1/2 md:w-1/3">
                            <div class="border border-gray-300 dark:border-gray-700">
                                ...
                                <div class="p-3 ">
                                    ...
                                    <p class="text-lg ">
                                        <span class="text-green-600 dark:text-green-600">RP 200.000</span>
                                    </p>
                                </div>
