            ...
            <div class=" grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
                <div>
                    <h1
                        ...
                        Temukan semua yang Anda butuhkan <span class="text-blue-600">Infinity Shop.</span></h1>
                    <p class="mt-3 text-lg text-gray-800 dark:text-gray-400">Beli berbagai macam produk elektronik
                        seperti Smartphone, Laptop, Smartwatch, Televisi, dan masih banyak lagi.</p>
            ...
            <div class="max-w-xl mx-auto">
                <div class="text-center ">
                    <div class="relative flex flex-col items-center">
                        <h1 class="text-5xl font-bold dark:text-gray-200"> Merk Brand<span class="text-orange-500">
                                Populer
                            </span> </h1>
                    ...
                    <p class="mb-12 text-base text-center text-gray-500">
                        Merek elektronik kami menghadirkan teknologi canggih dengan kualitas terbaik untuk memudahkan
                        hidup
                        Anda. Dengan desain elegan dan inovasi terkini, produk kami memberikan kenyamanan dan keandalan
            ...
            <div class="grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3 sm:gap-6">
                ...
                @foreach ($categories as $category)
                    <a class="group flex items-center bg-white border shadow-sm rounded-xl hover:shadow-md transition dark:bg-slate-900 dark:border-gray-800 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                        ...
                        <div class="p-4">
                            <svg class="flex-shrink-0 w-5 h-5 text-gray-500 group-hover:text-blue-600 dark:group-hover:text-gray-400 dark:text-gray-200"
