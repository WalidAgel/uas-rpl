<header
    class="flex z-50 sticky top-0 flex-wrap md:justify-start md:flex-nowrap w-full backdrop-blur-md bg-white/30 text-sm py-3 md:py-0 dark:bg-gray-800/30">
    <nav class="max-w-[85rem] w-full mx-auto px-4 md:px-6 lg:px-8" aria-label="Global">
        <div class="relative md:flex md:items-center md:justify-between">
            <div class="flex items-center justify-between">
                ...
                <div class="md:hidden">
                    <button type="button"
                        class="hs-collapse-toggle flex justify-center items-center w-9 h-9 text-sm font-semibold rounded-lg border border-gray-200/50 text-gray-800 hover:bg-white/50 disabled:opacity-50 disabled:pointer-events-none dark:text-white dark:border-gray-700/50 dark:hover:bg-gray-700/50 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
            ...
            <div id="navbar-collapse-with-animation"
                ...
                <div
                    ...
                    <div
                        ...
                        <a class="font-medium text-gray-900 hover:text-gray-600 py-3 md:py-6 dark:text-gray-100 dark:hover:text-gray-300 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                            href="/categories">
                            Categories
                        </a>
                        ...
                        <a class="font-medium flex items-center text-gray-900 hover:text-gray-600 py-3 md:py-6 dark:text-gray-100 dark:hover:text-gray-300 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                            href="/cart">
                        ...
                        <div class="hs-dropdown [--strategy:static] md:[--strategy:fixed] [--adaptive:none] md:[--trigger:hover] md:py-4">
                            ...
                            <div class="hs-dropdown-menu transition-[opacity,margin] duration-[0.1ms] md:duration-[150ms] hs-dropdown-open:opacity-100 opacity-0 md:w-48 hidden z-10 bg-white/70 backdrop-blur-md md:shadow-md rounded-lg p-2 dark:bg-gray-800/70 md:dark:border dark:border-gray-700/50 dark:divide-gray-700/50 before:absolute top-full md:border before:-top-5 before:start-0 before:w-full before:h-5">
                                <a class="flex items-center gap-x-3.5 py-2 px-3 rounded-lg text-sm text-gray-800 hover:bg-white/50 focus:ring-2 focus:ring-blue-500 dark:text-gray-300 dark:hover:bg-gray-700/50 dark:hover:text-gray-200 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                                    href="#">
                                    My Orders
                                </a>
                                <a class="flex items-center gap-x-3.5 py-2 px-3 rounded-lg text-sm text-gray-800 hover:bg-white/50 focus:ring-2 focus:ring-blue-500 dark:text-gray-300 dark:hover:bg-gray-700/50 dark:hover:text-gray-200 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
